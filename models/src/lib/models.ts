...
export const PokemonTypeSchema: z.ZodType<PokemonType> = z.union([
  z.literal('normal'),
  z.literal('fire'),
  z.literal('water'),
  z.literal('grass'),
...
export const SpeciesMetaSchema: z.ZodType<SpeciesMeta> = z.object({
...
export const EvolutionChainSchema: z.ZodType<EvolutionChain> = z.object({
...
// Loader contracts (stubs for completeness)
